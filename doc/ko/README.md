...
일반 텍스트 출력: [markdown은 여기](../xychart/generated.md)
````text
## XY Chart
```mermaid
xychart
...
일반 텍스트 출력: [markdown은 여기](../packet/generated.md)
````text
## Packet
```mermaid
packet
...
일반 텍스트 출력: [markdown은 여기](../kanban/generated.md)
````text
## Kanban Diagram
```mermaid
---
